                ...
                <form action="{{ route('admin.podcast.simpan') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="registration_fee"
                            ...
                            value="{{ old('registration_fee') }}" min="0" step="0.01">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="meeting_link"
                            ...
                            value="{{ old('meeting_link') }}" placeholder="https://zoom.us/...">
                        @error('meeting_link')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="is_event">
                            <input type="checkbox" name="is_event" id="is_event" value="1" {{ old('is_event') ? 'checked' : '' }}> Ini adalah Event
                        </label>
                    </div>
                    <div id="event-fields" style="display: none;">
                        <div class="form-group">
                            <label for="quota">Kuota Peserta</label>
                            <input type="number" name="quota" class="form-control @error('quota') is-invalid @enderror" value="{{ old('quota') }}" min="1">
                            @error('quota')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="registration_open" class="form-control @error('registration_open') is-invalid @enderror" value="{{ old('registration_open') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="registration_close" class="form-control @error('registration_close') is-invalid @enderror" value="{{ old('registration_close') }}">
