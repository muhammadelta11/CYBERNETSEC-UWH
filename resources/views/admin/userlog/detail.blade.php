        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('admin.userlog.edit', Crypt::encrypt($user->id)) }}" class="btn btn-primary">Edit</a>
                    @if($user->role !== 'admin')
                    <a href="{{ route('admin.userlog.delete', Crypt::encrypt($user->id)) }}"
                        class="btn btn-danger"
                        onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?')">Hapus</a>
                    @endif
                    <a href="{{ route('admin.userlog') }}" class="btn btn-secondary">Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
