        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('admin.userlog.detail', Crypt::encrypt($user->id)) }}" class="btn btn-secondary">Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.userlog.update', Crypt::encrypt($user->id)) }}" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('admin.userlog.detail', Crypt::encrypt($user->id)) }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
